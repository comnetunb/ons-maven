...
public class MyStatistics {
    ...
    /**
     * Creates a new ons.MyStatistics object, in case it does'n exist yet.
     *
     * @return the ons.MyStatistics singletonObject
     */
     ...
     *
     * @param flow the accepted ons.Flow object
     ...
     *
     * @param event the ons.Event object to be added
    ...
    protected String verboseStatistics(int simType) {
        ...
        if (simType >= 2) {
            stats += "Arrivals ons.Flow \t: " + Integer.toString(arrivalsFlow) + "\n";
            stats += "Arrivals Bulk \t: " + Integer.toString(arrivalsBulk) + "\n";
            stats += "Arrivals ons.Batch \t: " + Integer.toString(arrivalsBatch) + "\n";
        }
        stats += "Departures \t: " + Integer.toString(departures) + "\n";
        if (simType >= 2) {
            stats += "Departures ons.Flow \t: " + Integer.toString(departuresFlow) + "\n";
            stats += "Departures Bulk \t: " + Integer.toString(departuresBulk) + "\n";
            stats += "Departures ons.Batch \t: " + Integer.toString(departuresBatch) + "\n";
        }
        ...
        if (simType >= 2) {
            ...
            stats += "Accepted ons.Flow \t: " + Integer.toString(acceptedFlow) + "\t(" + Float.toString(acceptProb) + "%)\n";
            if (acceptedBulk == 0) {
                acceptProb = 0;
            } else {
        ...
        if (simType >= 2) {
            ...
            stats += "Blocked ons.Flow \t: " + Integer.toString(blockedFlow) + "\t(" + Float.toString(blockProb) + "%)\n";
            if (blockedBulk == 0) {
                blockProb = 0;
                bbr = 0;
            } else {
            ...
            stats += "Blocked ons.Batch \t: " + Integer.toString(blockedBatch) + "\t(" + Float.toString(blockProb) + "%)\n";
            stats += "Required Data Amount ons.Batch \t: " + Long.toString(requiredDataAmountBatch) + " Mbps\n";
            stats += "Blocked Data Amount ons.Batch \t: " + Long.toString(blockedDataAmountBatch) + " Mbps\n";
            stats += "BDAR ons.Batch      \t: " + Float.toString(bbr) + "%\n";
        }
        if (numClasses > 1) {
            ...
            if (simType >= 2) {
                stats += "Called Blocked by COS (%) (ons.Flow)" + "\n";
                for (int i = 0; i < numClasses; i++) {
                    ...
                    stats += "BR-ons.Flow-" + Integer.toString(i) + " " + Float.toString(bpDiff[i]) + "%\n";
                }
                ...
                stats += "Called Blocked by COS (%) (ons.Batch)" + "\n";
                for (int i = 0; i < numClasses; i++) {
                    ...
                    stats += "BR-ons.Batch-" + Integer.toString(i) + " " + Float.toString(bpDiff[i]) + "%\n";
                }
                stats += "BDAR by cos ons.Batch" + "\n";
                for (int i = 0; i < numClasses; i++) {
                    stats += "BDAR-ons.Batch-" + Integer.toString(i) + " " + Float.toString(bbrDiff[i]) + "%\n";
                }
            }
        }
        ...
        stats += "ons.OXC Average Sleep time: " + used + "%\n";
        ...
        if (simType >= 1) {
            for (int i = 0; i < modulations.length; i++) {
                stats += Modulation.getModulationName(i) + " ons.Modulation used: " + Float.toString((float) modulations[i] / (float) numLightPaths * 100) + "%\n";
            }
        }
        //For protection
        if (qtProtect > 0) {
        ...
        */
        /*ons.OXC Average Sleep time per node*/
        
        for (int i = 0; i < numNodes; i++) {
            used = (oxcSleepTime[i] - (oxcStateChange[i] * oxcTransitionTime)) / simulationTime * 100.0;
            stats += "ons.OXC Average Sleep time node["+i+"]: " + used + "%\n";
        }
    ...
    protected void printStatistics(int simType) {
        ...
        if (simType >= 2) {
            ...
            stats += "BR-ons.Flow: " + Float.toString(blockProb) + "%\n";
            if (blockedBulk == 0) {
                blockProb = 0;
                bbr = 0;
            } else {
            ...
            stats += "BR-ons.Batch: " + Float.toString(blockProb) + "%\n";
            stats += "BDAR-ons.Batch: " + Float.toString(bbr) + "%\n";
        }
        if (numClasses > 1) {
            stats += "Called Blocked by COS (%)" + "\n";
    ...
    protected void jsonStatistics(int simType, double load) {
        ...
        if (simType >= 2) {
            ...
            stats += "\"BR-ons.Flow\": " + jsonNormalizeNumber(blockProb) + ",\n\t";
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    if (blockedDiffFlow[i] == 0) {
                        bpDiff[i] = 0;
                    ...
                    stats += "\"BR-ons.Flow-"+ i +"\": " + jsonNormalizeNumber(bpDiff[i]) + ",\n\t";
                }
            }
            if (blockedBulk == 0) {
                blockProb = 0;
            ...
            stats += "\"BR-ons.Batch\": " + jsonNormalizeNumber(blockProb) + ",\n\t";
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    if (blockedDiffBatch[i] == 0) {
                        bpDiff[i] = 0;
                    ...
                    stats += "\"BR-ons.Batch-"+ i +"\": " + jsonNormalizeNumber(bpDiff[i]) + ",\n\t";
                }
            }
            stats += "\"BDAR-ons.Batch\": " + jsonNormalizeNumber(bbr) + ",\n\t";
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    stats += "\"BDAR-ons.Batch-"+ i +"\": " + jsonNormalizeNumber(bbrDiff[i]) + ",\n\t";
                }
            }
        }
    ...
    protected void printHeader(int simType) {
        ...
        if (simType >= 2) {
            System.out.print("BR-ons.Flow\t");
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    System.out.print("BR-ons.Flow-" + Integer.toString(i) + "\t");
                }
            }
            ...
            System.out.print("BR-ons.Batch\t");
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    System.out.print("BR-ons.Batch-" + Integer.toString(i) + "\t");
                }
            }
            System.out.print("BDAR-ons.Batch\t");
            if (numClasses > 1) {
                for (int i = 0; i < numClasses; i++) {
                    System.out.print("BDAR-ons.Batch-" + Integer.toString(i) + "\t");
                }
            }
        }
