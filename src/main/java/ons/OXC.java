 ...
 * output fiber link. The ons.OXC may also switch the optical signal on an
 * incoming wavelength of an input fiber link to some other wavelength on
 * an output fiber link.
 * 
 * The ons.OXC object has grooming input and output ports.
...
public abstract class OXC {
    ...
    private boolean sleep; //indicates whether the ons.OXC is sleeping or awake
    
    /**
     * Creates a new ons.OXC object. All its attributes must be given
    ...
    /**
     * Retrieves the ons.OXC's unique identifier.
     * 
     * @return the ons.OXC's id attribute
     */
    public int getID() {
        return id;
    }
    ...
    /**
     * Says whether or not a given ons.OXC has free
     * grooming input port(s).
     * 
     * @return true if the ons.OXC has free grooming input port(s)
     */
    ...
    /**
     * Says whether or not a given groomingInputPort in this ons.OXC has free
     * 
     * @param groomingInputPort id of groomingInputPort
     * @return true if the ons.OXC has free grooming input port id
     */
    ...
    /**
     * Says whether or not a given ons.OXC has all free
     * grooming input port(s).
     * 
     * @return true if the ons.OXC has all free grooming input port(s)
     */
     ...
     * The "groomingInputPort" can be -1 when the "ons.VirtualTopology" remove "Lightpath" that are on a optical grooming.
     * 
     ...
     * 
     * @return true if the ons.OXC has free grooming output port(s)
     */
    ...
    /**
     * Says whether or not a given groomingOutputPort in this ons.OXC has free
     * 
     * @param groomingOutputPort id of groomingOutputPort
     * @return true if the ons.OXC has free grooming output port id
     */
     ...
     * grooming output port(s).
     * 
     * @return true if the ons.OXC has all free grooming output port(s)
     */
     ...
     * The "groomingOutputPort" can be -1 when the "ons.VirtualTopology" remove "Lightpath" that are on a optical grooming.
     * 
    ...
    /**
     * Retrieves whether the ons.OXC is sleeping or awake
     * @return 
     */
