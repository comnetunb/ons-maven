 ...
 * @author lucas
 */
public class PseudoControlPlane2 implements ControlPlaneForRA {
    ...
    public static boolean PCP_accept, PCP_erase;
    protected MyStatistics st = MyStatistics.getMyStatisticsObject();

    public PseudoControlPlane2(ControlPlaneForRA cp, RA rsa) {
        this.cp = cp;
        this.rsa = rsa;
        this.currentId = -1;
    ...
    public boolean blockFlow(long id) {
        ...
        //o dealocated quem deve fazer e o RA
        if (PCP_erase) {
