...
public class KSPOffline {
    ...
    /**
     * Throws an exception to stop a cloned ons.MyStatistics object from being
     * created.
     */
    @Override
    ...
    /**
     * Retrieves the K-ons.Path of the K-Shortest Paths
     * @param source the source node
     * @param destination the destination node
     * @param k the k-path, starts from = 0
     * @return the K-ons.Path, starts from = 0
     */
