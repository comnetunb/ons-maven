...
public abstract class LightPath {
    ...
    /**
     * Creates a new ons.LightPath object.
     * 
    ...
    /**
     * Retrieves the unique identifier of a given ons.LightPath.
     * 
     * @return the ons.LightPath's id attribute
     */
    public long getID() {
        return id;
    }
    ...
    /**
     * Retrieves the source node of a given ons.LightPath.
     * 
     * @return the ons.LightPath's src attribute
     */
    ...
    /**
     * Retrieves the destination node of a given ons.LightPath.
     * 
     * @return the ons.LightPath's dst attribute.
     */
    ...
    /**
     * Retrieves the ons.LightPath's vector containing the identifier numbers
     ...
     * of elements in a ons.LightPath's list of fiber links, we get the number of
     * hops the ons.LightPath has.
     * 
     * @return the number of hops in a given ons.LightPath
     */
    public int getHops() {
        return links.length;
    }
    ...
    /**
     * Prints all information related to a given ons.LightPath, starting with
     * its ID, to make it easier to identify.
     * 
     * @return string containing all the values of the ons.LightPath's parameters
     */
    @Override
