...
public class Classifier {
    ...
    public Classifier() throws Exception {
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream( "ML/classifier_snr_lf.h5");
        this.model = KerasModelImport.importKerasSequentialModelAndWeights(inputStream);
    }
