...
public class Path {
    ...
    /**
     * Creates a new ons.Path object.
     * 
     * @param lightpaths list of ons.LightPath objects that form the ons.Path
     */
    ...
    /**
     * Returns the list of lightpaths that belong to a given ons.Path.
     * 
     * @return lightpaths list of ons.LightPath objects that form the ons.Path
     */
    ...
    /**
     * Retrieves if this ons.Path has this lightpath or not.
     * @param lp the lightpath
     * @return true if this ons.Path has this lightpath or not, false otherwise
     */
     ...
     * @param lightpaths lightpaths list of ons.LightPath objects
     */
