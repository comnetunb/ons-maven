...
/**
 * The ons.Batch class defines an object that has a group flows
 *
 */
public class Batch {
    ...
    /**
     * Create a new ons.Batch object.
     *
     * @param bulksIds uniques identifiers of ons.Batch and its BulkDatas
     * @param grupoSrc sources nodes of ons.BulkData calls
     * @param dstFinal destination node
     * @param arrayVariations data amout plus variations for each ons.BulkData call
    ...
    /**
     * Retrieves the unique identifier for a given ons.Batch.
     *
     * @return the value of the ons.Batch's id attribute
     */
    public long getID() {
        return this.id;
    }
    ...
    /**
     * Retrieves the array of the unique identifiers of BulkDatas into ons.Batch.
     *
     *
     * @return the value's array of the ons.BulkData's id attribute
     */
    public long[] getIds() {
     ...
     *
     * @return the sorces's array of ons.BulkData's calls
     */
    ...
    /**
     * Retrieves the destination ons.Batch.
     *
     * @return the destination of ons.BulkData's calls
     */
