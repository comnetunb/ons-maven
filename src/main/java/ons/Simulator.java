...
public class Simulator {
     ...
     * @param trace activates the ons.Tracer class functionalities
    ...
    public void Execute(String simConfigFile, String raClass, boolean trace, boolean verbose, boolean table, boolean json, double forcedLoad, int seed) {
        ...
        if (Simulator.verbose) {
            System.out.println("########################################################");
            System.out.println("# Optical Networks ons.Simulator - version " + simVersion.toString() + "  #");
            System.out.println("#######################################################\n");
        }
        ...
        try {
            ...
            */
            ...
            if (Simulator.verbose) {
                ...
                if (table) {
                    ...
                    if (json) {
                        ...
                        System.out.println("***RA Module: " + raClass + " ***");
                        if (forcedLoad != 0) {
            ...
            // Terminate ons.MyStatistics singleton
            st.finish();
