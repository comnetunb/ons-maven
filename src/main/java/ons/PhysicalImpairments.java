...
public class PhysicalImpairments {
     ...
     * @param lightpath the ons.LightPath Object
     */
     ...
     * @param link the ons.Link Object
    ...
    /**
     * Compute the SNR of this ons.LightPath and their neighbors.
    ...
    private double computeSNRlightpath(LightPath lp, int spectrumAssigned[], ArrayList<ArrayList<LightPath>> lightpathsNeighborsPerLink, LightPath newLP) {
        ...
        double Bsi = quantSlotsRequeridos * fs; //request bandwidth
        ...
        double I = Ptx / (fs * 4); //signal strength density for 4 slots which equals a wavelength in WDM 50 GHz
