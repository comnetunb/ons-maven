...
public class EONLink extends Link {
    ...
    /**
     * Retrieves the Spectrum Compactness (SC) in this ons.Link.
     ...
     * IEEE Access, 2018
     * 
     * @return the Spectrum Compactness (SC) in this ons.Link
     */
    public double getSC() {
    ...
    /**
     * Retrieves the Spectrum Compactness (SC) in this ons.Core.
     * YONGLI ZHAO, LIYAZHOU HU, RUIJIE ZHU, XIAOSONG YU, XINBO WANG and JIE ZHANG. 
     * Crosstalk-Aware Spectrum Defragmentation Based on Spectrum Compactness 
     * in Space Division Multiplexing Enabled Elastic Optical Networks With Multicore Fiber. 
     * IEEE Access, 2018
     ...
     * @return the Spectrum Compactness (SC) in this ons.Core
     */
    ...
    /**
     * Retrieves the First used slot in this ons.Link;
     * @return the First used slot in this ons.Link;
     */
    ...
    /**
     * Retrieves the First used slot in this ons.Core;
     * @param core the core id
     * @return the First used slot in this ons.Core;
     */
    ...
    /**
     * Retrieves the Last used slot in this ons.Link;
     * @return the Last used slot in this ons.Link;
     */
    ...
    /**
     * Retrieves the Last used slot in this ons.Core;
     * @param core the id core
     * @return the Last used slot in this ons.Core;
     */
    ...
    /**
     * Retrieve all lightpath ids from this link
     * @return all lightpath ids from this link
     */
    ...
    /**
     * Retrieves if another ons.Core in this link has the same spectrum available of this core
     * @param firstSlot the first slot of the core
     * @param lastSlot the last slot of the core
     * @param core the analyzed core
     * @return true if another ons.Core in this link has the same spectrum available of this core, false otherwise
     */
