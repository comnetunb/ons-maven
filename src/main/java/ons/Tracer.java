...
public class Tracer {
    ...
    /**
     * Creates a new ons.Tracer object, in case it doesn't exist yet.
     * 
     * @return the ons.Tracer's singletonObject attribute
     */
    ...
    /**
     * Throws an exception to stop a cloned ons.Tracer object from
     * being created.
     */
    @Override
    ...
    /**
     * Prints formatted representations of a ons.Tracer object to a text-output stream.
     * 
    ...
    /**
     * Adds an object to the trace file. If it is an ons.Event, the addEvent
    ...
    void acceptFlow(Flow flow, Path[] paths) {
        ...
        for (int i = 0; i < paths.length; i++) {
            str += " ons.Path-" + i + ": " + paths[i].toTrace();
        }
        if (writeTrace) {
            trace.println(str);
        }
     ...
     * 
     * @param lp the ons.LightPath object that was created
     */
     ...
     * 
     * @param lp    ons.LightPath object that was removed
     */
 ...
 either ons.FlowArrivalEvent or ons.FlowDepartureEvent.
     * 
